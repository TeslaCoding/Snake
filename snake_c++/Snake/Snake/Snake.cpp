...
int body[100][2];     // body
int n = 1;            // Used to increase snake lenght
int length = 7;       // Lenght of the body when the game starts
int x = 5;            // Coordinate x of the snake when the game starts
int y = 12;           // Coordinate y of the snake when the game starts      
int dir = 3;          // The direction of the snake when the game start
int xc = 0;			  // Food cooridinate x
int yc = 0;			  // Food cooridinate y
int speed = 0;        // Speed of the snake
int score = 0;        // Score
//int h = 1;				
int choice= 1;        // Used to save the choice you make
int s_diff;           // Used to save witch difficult you choose
...
void uppercase(string& name){                // Used to make the player's name in uppercase
	int i;
...
int menu(){                           //  move the select cursor to choose thing in the menu                  
	if(_kbhit()){                                      
			key = _getch();                             
			switch(key){                                
				case UP:                               
...
int menu_choice(){                 // Manges the choice you make in the menu 
	int choice_1;
	choice_1 = menu();
